...
HTTP_REQUEST_HEADERS: dict[str, str] = {
    "User-Agent": "nlp-module-4-tmartin/albums",
...
RAW_JSON_PATH: Path = RAW_PATH / "tmartin_albums_raw.json"
PROCESSED_CSV_PATH: Path = PROCESSED_PATH / "tmartin_albums_processed.csv"
